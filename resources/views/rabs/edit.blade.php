  ...
  <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="form-group">
              ...
              <input type="text" name="no_rab" class="form-control" placeholder="NO RAB" value="{{ $rab->no_rab }}" disabled>
              @error('no_rab')
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="form-group">
              ...
              <select name="id_penyusun" id="id_penyusun" class="form-select">
                ...
                <option value="{{ $item->id }}" {{ ($item->id==$rab->id_penyusun)? 'selected': ''}}>{{ $item->name }}</option>
                @endforeach
              </select>
              @error('id_penyusun')
              <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
